...
from db.repositories.poste_coverage_requirement_repo import PosteCoverageRequirementRepository
...
poste_coverage_requirement_repo = PosteCoverageRequirementRepository()
