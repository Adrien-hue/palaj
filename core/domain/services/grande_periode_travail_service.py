# core/domain/services/grande_periode_travail_service.py
...
class GrandePeriodeTravailService:
    """Service de détection et d'analyse des Grandes Périodes de Travail (GPT)."""

    def detect_gpts(self, context: PlanningContext) -> List[GrandePeriodeTravail]:
        """
